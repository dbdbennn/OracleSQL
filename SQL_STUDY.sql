...
-- USER SQL
CREATE USER "JE" IDENTIFIED BY "1234"  
DEFAULT TABLESPACE "USERS"
TEMPORARY TABLESPACE "TEMP";

-- QUOTAS
ALTER USER "JE" QUOTA UNLIMITED ON "USERS";

-- ROLES
GRANT "CONNECT" TO "JE" ;
GRANT "RESOURCE" TO "JE" ;
...
-- membertbl add data
INSERT INTO MEMBERTBL (MEMBERID, MEMBERNAME, MEMBERADDRESS) VALUES ('KANG', N'강아지', '서울시 관악구 신림동');
INSERT INTO MEMBERTBL (MEMBERID, MEMBERNAME, MEMBERADDRESS) VALUES ('GOYA', N'고양이', '경기 성남시 분당구');
INSERT INTO MEMBERTBL (MEMBERID, MEMBERNAME, MEMBERADDRESS) VALUES ('MANG', N'망아지', '인천 부평시 부평구');
INSERT INTO MEMBERTBL (MEMBERID, MEMBERNAME, MEMBERADDRESS) VALUES ('SONG', N'송아지', '대전 유성구 도마동');
...
CREATE SEQUENCE SEQUENCE INCREMENT BY 10 START WITH 1;
...
BEGIN
  ...
  BEGIN
    IF INSERTING AND :NEW.IDNUM IS NULL THEN
      SELECT SEQUENCE.NEXTVAL INTO :NEW.IDNUM FROM SYS.DUAL;
    END IF;
